...
namespace AutomaticCode
{
    ...
    public sealed class SqlHelper
    {
        ...
        {
            return ConfigurationManager.ConnectionStrings["DataMode"].ConnectionString;
            //return "";
        }

        public static void IniConnString()
        {
            connstr = ConfigurationManager.ConnectionStrings["DataMode"].ConnectionString;
        }
        /// <summary> 
        /// 一个有效的数据库连接对象 
        /// </summary> 
        ...
        {
            return ExecuteDataset(connstr, CommandType.Text, commandText, (SqlParameter[])null);
        }
        /// <summary> 
        /// 执行指定数据库连接字符串的命令,返回DataSet. 
        /// </summary> 
        ...
        {
            // 执行参数为空的方法 
            return ExecuteScalar(connstr, commandType, commandText, (SqlParameter[])null);
        }
